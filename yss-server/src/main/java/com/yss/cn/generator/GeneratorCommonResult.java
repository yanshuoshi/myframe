 ...
 **/
public class GeneratorCommonResult {
...
//        gc.setXmlName("%sMapper");
        ...
        pc.setParent("com.yss.cn.api.result");
        pc.setController("%s");
...
//        tc.setController("");
        ...
        tc.setMapper("");
        tc.setXml("");
        tc.setController("templates/result.java");// /templates/entity.java 模板路径配置，默认再templates
